 ...
 */
public class BTree<K, V> extends AbstractMap<K, V> implements SortedMap<K, V>, Serializable {
    ...
    /**
     * Creates a new BPlusTree of order and leaf order 3 and assumes that all keys implement Comparable.
     */
    public BTree() {
    ...
    /**
     * Creates a new BPlusTree of order and leaf order 3.
     *
    ...
    /**
     * Creates a new BPlusTree and assumes that all keys implement Comparable.
     *
     ...
     */
    public BTree(int order, int leafOrder)
     ...
     * @throws IllegalArgumentException thrown if order < 3 or leafOrder < 1.
     */
    BTree(Comparator c, int order, int leafOrder)
            throws IllegalArgumentException {
        this.comp = c;
        this.order = order;
    ...
    /**
     * Returns the first key currently in this BPlusTree.
     */
    public K firstKey() {
        if (size == 0)
    ...
    /**
     * Returns the last key currently in this BPlusTree.
     */
    public K lastKey() {
        if (size == 0)
            throw new NoSuchElementException();
    ...
    /**
     * Returns the comparator associated with this BPlusTree, or null if it uses its keys' natural ordering.
     */
    public Comparator<K> comparator() {
        if (comp instanceof BTree.DefaultComparator)
            return null;
        else
            return comp;
    }
    ...
    /**
     * Returns the number of key-value mappings in this BPlusTree.
     */
    public int size() {
        return size;
    }
    ...
    /**
     * Removes all mappings from this BPlusTree.
     */
    public void clear() {
        root = firstLeaf = new LeafNode();
        size = 0;
    ...
    /**
     * Returns true if this BPlusTree contains a mapping for the specified key.
     */
    public boolean containsKey(Object key) {
        Node cur = root;
        while (cur instanceof BTree.GuideNode) {
    ...
    /**
     * Returns the value to which this BPlusTree maps the specified key or null if it contains no mapping for the key.
     */
    ...
    public V remove(Object key) {
        ...
        if (root instanceof BTree.GuideNode && root.keys.size() == 1)
    ...
    /**
     * Returns a set view of the entries mapped in this BPlusTree.
     */
    ...
    /**
     * Returns a map representing a sub-range of the keys stored in this BPlusTree.
     */
    ...
    /**
     * Prints this BPlusTree to the specified StringWriter in XML format.
     */
     ...
     */
    private class GuideNode extends Node implements Serializable{
        ...
        private int findGuideIndex(Object key) {
            return BTree.this.findGuideIndex(this, key);
        }
    ...
    private class LeafNode extends Node implements Serializable {
        ...
        private int findLeafIndex(Object key) {
            return BTree.this.findLeafIndex(this, key);
        }
     ...
     */
    private static class DefaultComparator<K> implements Comparator<K>, Serializable {
        /**
    ...
    /**
     * A SortedMap which represents a sub-region of the key-space mapped by a BPlusTree.
     */
    private class SubMap extends AbstractMap<K, V> implements SortedMap<K, V>, Serializable {
        ...
        /**
         * Creates a new SubMap representing the entire BPlusTree.
         */
        public SubMap() {
            low = null;
            high = null;
         ...
         */
        public boolean containsKey(Object key) {
            return checkKey(key) && BTree.this.containsKey(key);
        }
        ...
        public SortedMap<K, V> subMap(K arg0, K arg1) {
            ...
            // Return a new SubMap.
            return BTree.this.subMap(newLow, newHigh);
        }
         ...
         */
        private class EntrySet extends AbstractSet<Entry<K, V>> implements Serializable{
            /**
             ...
             */
            private class EntrySetIterator implements Iterator<Entry<K, V>>, Serializable {
                ...
                public EntrySetIterator() {
                    modCount = BTree.this.modCount;
                    curNode = BTree.this.firstLeaf;
                ...
                public Entry<K, V> next() {
                    ...
                    if (modCount != BTree.this.modCount)
                    ...
                    // Get entry.
                    lastEntry = new BPTEntry(curNode.keys.get(curIndex), BTree.this);
    ...
    /**
     * An entry in a BPlusTree bound to a key and backed by the tree.
     */
    private class BPTEntry implements Entry<K, V>, Serializable {
        private K key;
         ...
         */
        public BPTEntry(K key, BTree<K, V> tree) {
            this.key = key;
            this.tree = tree;
        }
        ...
        /**
         * Sets the value associated with this entry. The BPlusTree will be changed to reflect the new value.
         */
